...
_items = [
    ...
    "equipment", "equipment x", "equipment equip", "equipment equip 1", "equipment equip 2", "equipment equip 1", "equipment equip x", "equipment unequip", "equipment unequip sword", "equipment unequip shield", "equipment unequip x", "equipment equip 1", "equipment equip 2", # equipment cmd
    "travel", "y", "travel", "102", # travel cmd
    "roam", "y", "n", # roam cmd
